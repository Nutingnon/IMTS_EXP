...
parser.add_argument('--irregular_value_norm', type=str, choices=['legacy_global', 'none', 'train_only'], default='legacy_global', help='Value normalization mode for irregular datasets. legacy_global keeps current behavior, none disables value normalization, train_only fits value statistics on the training split only.')
